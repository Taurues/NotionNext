...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到小张的博客哟🎉🎉🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小张少吃点啊', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '草原悍匪🙇‍♂️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址暂无
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE || '文章类型', // 文章类型，
    ...
    status: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS || '发布状态',
    status_publish:
    ...
    summary: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SUMMARY || '文章描述',
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '文章短链接',
